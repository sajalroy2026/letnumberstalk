...
export const DISCLOSURE = {
  ...
  body: "The diagnostic readings, scoring, and Areas to Look Into content generated by this application are presented as a structured self-assessment resource, built on AI-augmented research synthesis, and contributed for informational purposes. They are intended to support informed decision-making, not to substitute for it. Every business context carries variables that no automated assessment can fully account for. Users are encouraged to engage qualified professional advisors before translating any output of this application into structural, operational, financial, or investment decisions.",
};
